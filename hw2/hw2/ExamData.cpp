...
ExamData::ExamData(char* name, int age, char* subject, int grade, char* date) 
...
bool isBiggerByGrade(const ExamData& t, const ExamData& other)
{
	return t.grade >= other.grade;
}
bool isSmallerByGrade(const ExamData& t, const ExamData& other)
{
	return t.grade <= other.grade;
}
